...
class UserLogService{
    ...
    public function get_fund_log_list(int $uid, string $coin_type, int $page, int $limit = 10){
        return (new LogUserFundRepository())->use_fields_get_list([
            ['uid', '=', $uid],
            ['coin_type', '=', $coin_type]
        ], $page, $limit);
    }
    ...
    public function get_sys_message_list($uid, $page, $limit = 10){
        ...
        $data = $LogSysMessageRepository->use_fields_get_list([['uid', 'in', [0, $uid]]], $page, $limit, ['id', 'desc'], ['id', 'title', 'image', 'updated_at']);
    ...
    public function get_sys_message_detail($uid, $id){
        $LogSysMessageRepository = new LogSysMessageRepository();
        $data = $LogSysMessageRepository->use_field_get_data([['id', '=', $id]]);
